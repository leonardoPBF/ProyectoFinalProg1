...
namespace ProyectoFinalProg1.Controllers
{
    public class AdministradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,Apellidos,Email,contraseña")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Apellidos,Email,contraseña")] Administrador administrador)
        {
